 ...
 * @author Diego
 * 
 * Criamos então uma classe que será responsável por receber as configurações da aplicação no pacote service
 * Injetamos portando nessa classe todas as declarações necessárias que estavam na primeira app apenas CRT-c crt-v
 * 
 */


@Service //Sem essa anotaçõa ele não entende que o dbService é um componente do spring, tendo ela passa a ser injetado em outros lugares
public class DBService {
    ...
    //Função responsãvel por instanciar o banco de dados
    //Ela se encontra lá na classe TestConfig.java    
